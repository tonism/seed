...
minimal DHCPDISCOVER; DHCP offer parsing, DNS, and outbound reachability are
next.
...
vm-net-ne2k8         8-bit NE2000-compatible; expected: adapter prompt, MAC read, RX read check, DHCPDISCOVER, then seed build 5
vm-net-novell-ne1k   Novell NE1000; expected: adapter prompt, MAC read, RX read check, DHCPDISCOVER, then seed build 5
