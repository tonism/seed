...
- 2026-06-11 — **NIC HAL vtable LANDED (increments A/B/C/D, commits f65f46d, c8867a4,
  ...
  Detailed dispatch map + original design: the HAL appendix at the end of this file.
...
# Appendix — NIC HAL execution brief (folded from build12-hal-handover.md)

> Executed; the LANDED outcome + refinements are in the grind log above. Kept here
> for the detailed dispatch map + the original design record. (Convention: one
> attempts file per build — the standalone handover doc was folded + removed.)
