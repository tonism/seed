...
## 2026-05-08 10:32:35 - Add explicit 16 KiB budget reporting
...
## 2026-05-08 10:32:35 - Move save-only `USER.CFG` key labels out of resident data
...
## 2026-05-08 10:32:35 - Move TLS receive/pre-response arena out of resident file bytes
...
## 2026-05-08 10:32:35 - Recover after unsafe ClientHello phase experiment
...
## 2026-05-08 10:32:35 - Move TLS/P-256 working state to high scratch
...
## 2026-05-08 10:32:35 - Move setup-only packet builders into setup phases
...
## 2026-05-08 10:32:35 - Move packet I/O initialization into a setup window
...
## 2026-05-08 10:32:35 - Prune unused TLS extension flag state
...
## 2026-05-08 10:32:35 - Move SHA-256 block schedule to high scratch
...
## 2026-05-08 11:37:34 - Prebuild TLS ClientHello before TCP connect
...
## 2026-05-08 11:37:34 - Remove obsolete resident ClientHello extension tail
...
## 2026-05-08 11:37:34 - Move DNS qname into pre-connect scratch
...
## 2026-05-08 11:37:34 - Shrink phase runner stubs
...
## 2026-05-08 14:32:18 - Add explicit scratch collision reporting
...
## 2026-05-08 14:32:18 - Move boot/UI/config helpers into setup windows
...
## 2026-05-08 14:32:18 - Small resident UI/startup cuts, keep DNS state resident
...
## 2026-05-08 14:32:18 - Move phase-local setup state to low scratch tail
...
## 2026-05-08 14:32:18 - Move remaining setup wrappers out of the resident path
...
## 2026-05-08 14:32:18 - Move config FAT lookup/state into setup windows
...
## 2026-05-08 15:41:35 - Stage TLS random and client public key in high scratch
...
## 2026-05-08 15:41:35 - Trim critical scratch to actual pre-response tail
...
## 2026-05-08 15:41:35 - Rejected OpenAI max-output request-shape cut
...
## 2026-05-08 16:51:50 - Move fixed TLS constants into low scratch
...
## 2026-05-08 16:51:50 - Stage SHA-256 K table in bootstrap scratch
...
## 2026-05-08 16:51:50 - Move remaining TLS constants and crypto state to low memory
...
## 2026-05-08 19:27:03 - Drop one resident sector with TLS/runtime cleanup
...
## 2026-05-08 19:27:03 - Rejected compact ChaCha double-round
...
## 2026-05-08 19:27:03 - Rejected post-TCP crypto runtime preload
...
## 2026-05-08 21:01:25 - Keep low-risk TLS tail-call cleanup
...
## 2026-05-08 21:01:25 - Failed TCP receive window shrink
...
## 2026-05-08 21:01:25 - Keep follow-up tail-position cleanup
...
## 2026-05-08 21:01:25 - Failed TLS bookkeeping and CKE scratch reuse cut
...
## 2026-05-08 22:18:16 - Compact high crypto scratch overlay
...
## 2026-05-08 22:18:16 - Rejected seed config pre-ClientHello overlay
...
## 2026-05-08 22:18:16 - Rejected 1024-byte TCP receive cap
...
## 2026-05-09 00:06:26 - Rejected ClientKeyExchange public key config-arena reuse
...
## 2026-05-09 00:06:26 - Rejected universal early ClientKeyExchange plus public-key reuse
...
## 2026-05-09 00:06:26 - Cut OpenAI request buffer to fixed proof bounds
...
## 2026-05-09 00:06:26 - Overlay post-request TLS state on saved config arena
...
## 2026-05-09 00:06:26 - Rejected packed phase wrapper immediates
...
## 2026-05-09 00:06:26 - Move TCP SYN construction into TCP-connect phase
...
## 2026-05-09 00:06:26 - Keep compact NIC transmit port setup
...
## 2026-05-09 00:06:26 - Keep compact NIC receive port setup
...
## 2026-05-09 00:06:26 - Keep compact NIC pointer setup
...
## 2026-05-09 03:24:55 - Trim resident network/phase glue to 21 sectors
...
## 2026-05-09 03:24:55 - Keep compact resident NIC helper tails
...
## 2026-05-09 04:03:29 - Trim unused HMAC third segment and successful TLS status writes
...
## 2026-05-09 05:04:01 - Move crypto/API implementation into natural LINK window
...
## 2026-05-09 05:11:56 - Add LINK-aware packed budget tracking
...
## 2026-05-09 07:15:39 - Move fixed TLS client public key out of high scratch
...
## 2026-05-09 07:47:30 - Rejected low TCP receive cap
...
## 2026-05-09 07:47:30 - Rejected TLS nonce/AAD helper dedupe
...
## 2026-05-09 07:59:08 - Move transient AEAD scratch into critical scratch
...
## 2026-05-09 08:14:47 - Reject direct key-block write-key aliases
...
## 2026-05-09 08:46:59 - Move SHA-256 block/schedule scratch into low sector buffer tail
...
## 2026-05-09 09:05:29 - Size TLS reassembly to payload bytes instead of frame bytes
...
## 2026-05-09 09:30:09 - Rejected low HMAC scratch alias
...
## 2026-05-09 10:45:20 - Rejected partial low HMAC scratch alias
...
## 2026-05-09 10:45:20 - Rejected prepared-only TLS app send cleanup
...
## 2026-05-09 11:22:59 - Trim unused ServerKeyExchange parse state
...
## 2026-05-09 11:49:55 - Reject TLS status-tail and fixed-scalar P-256 include cleanup
...
## 2026-05-09 12:10:40 - Reject request-record receive-buffer reuse
...
## 2026-05-09 13:24:35 - Rejected TLS transcript/key-schedule bookkeeping trim
...
## 2026-05-09 13:24:35 - Drop unused TLS transcript length counters
...
## 2026-05-09 14:38:19 - Rejected transient HMAC pad scratch
...
## 2026-05-09 14:38:19 - Rejected TLS client public key phase relocation
...
## 2026-05-09 14:38:19 - Inline fixed P-256 premaster stub
...
## 2026-05-09 15:04:58 - Remove no-op premaster preparation calls
...
## 2026-05-09 15:46:06 - Inline TLS success helper
...
## 2026-05-09 17:06:44 - Merge TLS record sequence clear helpers
...
## 2026-05-09 18:24:14 - Overlay transient high-crypto work
...
## 2026-05-09 18:43:31 - Move transient crypto work to low packet arena
...
## 2026-05-09 19:20:01 - Compact ChaCha double-round code
...
## 2026-05-09 20:02:31 - Reject in-place TLS application response buffer
...
## 2026-05-09 20:31:15 - Move Finished verify_data into high scratch
...
## 2026-05-09 21:43:05 - Reject 512-byte TLS copy arena
...
## 2026-05-09 21:43:05 - Reject TLS tag alias into nonce scratch
...
## 2026-05-09 21:43:05 - Share TLS record-sequence helpers
...
## 2026-05-10 00:14:30 - Reject shared TLS app AAD helper
...
## 2026-05-10 00:14:30 - Reject 1024-byte TLS payload arena
...
## 2026-05-10 00:14:30 - Reject resident-sector state move
...
## 2026-05-10 00:14:30 - Accept tiny resident and LINK cleanups
...
## 2026-05-10 00:14:30 - Reject packet-path resident gate move
...
## 2026-05-10 00:14:30 - Accept packet-family predicate removal
...
## 2026-05-10 01:53:01 - Reject receive-buffer cut without segment-safe receive
...
## 2026-05-10 01:53:01 - Compact ChaCha quarter-round helper
...
## 2026-05-10 02:37:24 - Reach full 1 KiB guarded Build 7 fit
...
## 2026-05-10 04:02:24 - True 16 KiB profile matrix

Change:

- Switched all active 86Box profiles to 16 KiB RAM.
- Moved the ROM BASIC sidecar machine-code loader from `0x5a00` to `0x3a00`.
- Set the BASIC helper RAM ceiling to `0x4000` and `CLEAR` top to 14847 so the
  helper lives inside a real 16 KiB machine.
- Made the measured packed scratch map real by moving high crypto scratch to
  `0x3200` and critical scratch to `0x32c2`.

Reasoning:

- The first true 16 KiB profile booted ROM BASIC and accepted the typed helper,
  but `RUN` restarted into ROM BASIC because the old `0x5a00` loader address was
  above the installed RAM ceiling.
- After moving the BASIC loader down, NE2K8 loaded Seed but failed at network
  setup. `make inspect` had been measuring high/critical scratch as packed below
  `0x4000`, while the runtime still used the older 24 KiB-era addresses. Moving
  the real scratch arenas to the measured locations made the 16 KiB runtime match
  the budget model.
...
- High-crypto scratch stayed 194 bytes at `0x3200..0x32c2`.
- Critical scratch stayed 2097 bytes at `0x32c2..0x3af3`.
- `16k-target critical raw slack` is 1293 bytes.
- `16k-target critical guarded slack` is +269 bytes against the preferred 1 KiB
  guard.

Result:

- Accepted. This turns the guarded 16 KiB fit from a measurement-only milestone
  into a tested 16 KiB ROM BASIC profile milestone across the full NIC set.

Verification:

- `make inspect` passed.
- `make test` passed.
- 16 KiB ROM BASIC sidecar profile `vm-net-ne2k8` reached returned `ok`.
- 16 KiB ROM BASIC sidecar profile `vm-net-3c501` reached returned `ok`.
- 16 KiB ROM BASIC sidecar profile `vm-net-3c503` reached returned `ok`.
- 16 KiB ROM BASIC sidecar profile `vm-net-ne1k` reached returned `ok`.
- 16 KiB ROM BASIC sidecar profile `vm-net-novell-ne1k` reached returned `ok`.
- 16 KiB ROM BASIC sidecar profile `vm-net-wd8003e` reached returned `ok`.
