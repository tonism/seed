...
| --- | --- | --- | --- |
| `vm-net-3c501` | Improving. Historical `5+5`; current WIP has short recovered and multiple strict current long/follow-up passes after the completion-marker and window-only gate fixes, but the current long gate was paused before reaching `5/5`. | `2026-05-21T02:47`: short `5/5` at `/tmp/seed-matrix-3c501-short-presendrx-20260521T0123`; long `5/5` at `/tmp/seed-matrix-3c501-long-presendrx-20260521T0153`. `2026-05-26T00:05`: current short `5/5` at `/private/tmp/seed-matrix-3c501-short-ckefirst-20260525T2340`. `2026-05-27T06:31`: pcap evidence for split `output_text.done` causing long completion miss; parser now keys on `response.completed`. `2026-05-27T08:42`: strict current long/follow-up pass at `/private/tmp/seed-3c501-long-followup-windowonly-gatefix-20260527T0835.pcap`. `2026-05-27T09:39`: two strict passes in `/private/tmp/seed-matrix-3c501-long-windowonly-20260527T0842`, plus one strict pass in `/private/tmp/seed-matrix-3c501-long-windowonly-gatefix-20260527T0920`; paused before completing `5/5`. | Resume current long `5/5`, then a short guardrail. Keep the 3c501 lane isolated while doing this. |
...
| `vm-net-ne2k8` | Current short-loop spot pass; historical focused stable. | `2026-05-20T12:56`: focused short `5/5` and long `5/5`. `2026-05-23T23:38`: focused long plus `Say done.` follow-up pass at `/private/tmp/seed-ne2k8-long-directrender-rerun-20260523T2302.pcap`. `2026-05-27T11:12`: one current five-prompt short session passed under `/private/tmp/seed-matrix-remaining-short-scan-20260527T1022`. | Use as current NE control, but still needs focused current `5/5` after 3c503/NE1K failures are understood. |
...
| `vm-net-wd8003e` | Current short lane looks healthy; strict harness was `4/5` because one run had capture failure, with four clean product passes. | `2026-05-20T15:50`: short profile passed and long matrix was `5/5`. `2026-05-22T13:29`: short `5/5`, long had prompt-return/fatal failures. `2026-05-27T11:12`: current one-run short scan under `/private/tmp/seed-matrix-remaining-short-scan-20260527T1022` was invalid because the harness could not capture the window before gate 1. `2026-05-27T15:11`: serial short matrix under `/private/tmp/seed-matrix-wd-short-20260527T1355` was strict `4/5`; run 1 was capture-invalid after `Say one.`, runs 2-5 cleanly passed all five prompts. | Treat short path as likely good but rerun one clean replacement if strict `5/5` is required. Long lane still needs current recheck. |
