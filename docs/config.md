...
the boot medium. P-256 point math, ECDHE, TLS transcript digest finalization,
the remaining TLS handshake, authenticated API calls, capability fetches,
model selection, and reasoning selection are still build 6 follow-up work.
