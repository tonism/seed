...
coordinate range checks, P-256 field add/sub/mul/reduction helpers that are not
yet wired into live curve validation, ServerHelloDone proof, live SHA-256 TLS
