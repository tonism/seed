...
CLIENT_PRIVATE = 0x0000000000000000000000000000000000000000000000008000000000000001
PEER_PRIVATE = 0x7D7DC5F71EB29B1D0E3F3B3C53B9786D61A39F4F7775DA0F2C4D2C00B928D7D8
CLIENT_PUBLIC = (
    0xC20431C40BA25E0A9FC50F97219772C0D950C96FFC6ED1A7C6B951B716A86CB0,
    0x68FC153BA3BD9430D02A49E3E220632B0D3760CDE887EFBEA33A5E2ADD41DAA4,
)
PEER_PUBLIC = (
...
SHARED_X = 0x54A563AEEF284C14E77886BB5EB5D802DA078C867329F8BA96918ACC9DA266C3
...
def check_field_words() -> None:
    ...
    assert parse_dw_words("p256_prime_minus_2") == to_words_le(P - 2)
